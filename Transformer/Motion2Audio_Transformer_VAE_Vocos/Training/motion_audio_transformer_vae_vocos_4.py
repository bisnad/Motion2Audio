"""
motion to audio transformer that operates on the audio side on mel spectra generated by vocos and then encoded by a VAE
same as motion_audio_transformer_vae_vocos_4.py
but in addition to latent loss also with mel loss and perceptial loss
"""
