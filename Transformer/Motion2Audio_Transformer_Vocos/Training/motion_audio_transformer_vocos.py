"""
that operates on the audio side on mel spectra generated by vocos
"""
...
for sI in range(len(mocap_all_data)):
    ...
    for mfI in range(3, mocap_frame_count - mocap_input_output_seq_length - 10, mocap_frame_incr):
        ...
        #print("asI ", asI, " awe s ", audio_waveform_excerpt.shape, " ame s ", audio_mels_excerpt_norm.shape)
        
        X_audio.append(audio_mels_excerpt_norm.cpu())
        ...
        for tsI in range(mocap_output_seq_length):
            ...
            #print("asI ", asI, " awe s ", audio_waveform_excerpt.shape, " ame s ", audio_mels_excerpt.shape)
            
            y_audio_grouped.append(audio_mels_excerpt_norm.cpu())
